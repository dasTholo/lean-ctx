...
| Add gotcha | `@call add_gotcha(title, body)` | `mcp__lean-ctx__ctx_knowledge action=remember category=gotcha` |
| List gotchas | `@call list_gotchas(query)` | `mcp__lean-ctx__ctx_knowledge action=recall category=gotcha` |
