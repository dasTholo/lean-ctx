...
> **Latest version: 3.6.10** — 69 MCP tools · 10 read modes · 60+ shell patterns
...
2. **MCP Server** — 69 tools for cached file reads, 10 read modes, deltas, dedup, memory, multi-agent coordination, and more
...
**Q: Where can I find docs for all 69 tools?**
...
- **Full (default)**: All 69 tools available as separate `ctx_*` tools
