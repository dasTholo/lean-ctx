...
| Total Sessions | 683 |
| Input Tokens | 188.2M |
| Output Tokens | 103.5M |
| Tokens Saved | 84.7M (45.0%) |
| Shell Commands | 121,099 |
...
G9 Self-Pilot: **FAIL** — requires at least 180 days of continuous, measured self-pilot usage plus non-zero sessions and token traffic. This report uses only the live `lean-ctx stats json` and agent-bus output captured at generation time.
