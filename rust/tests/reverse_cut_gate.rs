...
///
/// Allowed survivors:
///   - `rust/src/tools/registered/ctx_read.rs`     — auto-render delegation hook
///   - `rust/src/core/addons/registry.rs`           — flagship/search tests use "lean-md" as addon name/slug
///   - `rust/src/core/addons/manifest.rs`           — is_slug test uses "lmd" as slug literal
...
/// Only addon-name/slug references remain in exactly these three addons files.
/// Any NEW lmd code line in any other addons file will be caught by this gate.
///
