  ...
  render() {
    ...
    this.innerHTML = '<section aria-label="Solution Intelligence" style="background:var(--bg-card);border:1px solid var(--border);border-radius:12px;padding:20px;color:var(--text-primary);">' +
      ...
      '<div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;">' +
        ...
        '<div style="border:1px solid var(--border);border-radius:8px;padding:13px;"><div style="color:var(--text-tertiary);font-size:10px;letter-spacing:.08em;">NET LOC REDUCED</div><div style="font-size:25px;font-weight:700;margin-top:6px;">-' + csolFormat(netReduced) + '</div><div style="color:var(--text-tertiary);font-size:10px;margin-top:3px;">' + csolPercent(loc.reduction_pct) + ' of removed LOC</div></div>' +
